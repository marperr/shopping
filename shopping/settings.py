...
SECRET_KEY = 'bam@z7ygek4t#a&dokpfs1ch+oc(uqo9u4bpf%m2s4n183-tal'
...
#os.path.join(BASE_DIR, was in the database name
...
#TEMPLATE_LOADERS = (
 #   'django.template_loaders.filesystem.loader',
  #  'django.template_loaders.appdirectories.loader',
   # )
